<div class="tab-pane" id="antHeredofamiliares">
	<div class="box-generic">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				{!! Form::text('enfermedadesMadre', '', ['class' => 'required form-control']) !!}
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				{!! Form::text('enfermedadesPadre', '', ['class' => 'required form-control']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('enfermedadesAbuelosPaternos', '*Enfermedades abuelos paternos:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-8">
				{!! Form::textarea('enfermedadesAbuelosPaternos', null, ['class' => 'required form-control', 'rows' => '6']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('enfermedadesAbuelosMaternos', '*Enfermedades abuelos maternos:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-8">
				{!! Form::textarea('enfermedadesAbuelosMaternos', null, ['class' => 'required form-control', 'rows' => '6']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('numHermanos', '*Número de hermanos:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-2">
				{!! Form::text('numHermanos', null, ['class' => 'required numerosEnteros form-control']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('numHermanosVivos', '*Vivos:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-2">
				{!! Form::text('numHermanosVivos', null, ['class' => 'required numerosEnteros form-control']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('numHermanosFinados', '*Finados:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-2">
				{!! Form::text('numHermanosFinados', null, ['class' => 'required numerosEnteros form-control', 'readonly' => 'readonly']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('nombresEdades', '*Nombres y Edades:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-8">
				{!! Form::textarea('nombresEdades', null, ['class' => 'required form-control', 'rows' => '6']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('enfermedadesHermanos', '*Enfermedades que padecen o padecieron:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-8">
				{!! Form::textarea('enfermedadesHermanos', null, ['class' => 'required form-control', 'rows' => '6']) !!}
			</div>
		</div>
	</div>
</div>