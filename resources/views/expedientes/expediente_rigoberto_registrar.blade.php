														...
														<div class="widget widget-tabs widget-tabs-double widget-tabs-vertical row row-merge" id="widgetForm">
															...
															<div class="widget-body col-md-9 col-lg-9">
																...
																<div class="tab-content">
																	...
																	@if(!isset($expediente) || is_null($expediente->getExpedienteRigoberto()))
																		@include('expedientes.expediente_rigoberto_registrar_antecedentes_no_patologicos')
																	@else
																		@include('expedientes.expediente_rigoberto_editar_antecedentes_no_patologicos')
																	@endif
