							...
							<div class="col-app">
                                <div class="innerAll">
                                    <div class="media">
                                        ...
                                        <div class="media-body innerAll half">
                                            ...
                                            <p>{{ $expediente->getPaciente()->edadCompleta() }}<br/>Vive en: {{ $expediente->getPaciente()->getLugarNacimiento() }}<br/>Expediente {{ !is_null($expediente->getExpedienteRigoberto()) ? $expediente->getExpedienteRigoberto()->numero() : '--' }}</p>
                                        </div>
                                    </div>
                                </div>
								<div class="col-separator-h"></div>
								<div class="innerAll">
									<div class="wizard">
										...
										@include('expedientes.expediente_rigoberto_pestanias')
										<div class="widget-body col-md-9 col-lg-9">
											...
											!!}
												<div class="innerAll">
													@if(!is_null($expediente->getExpedienteRigoberto()) && !$expediente->getExpedienteRigoberto()->revisado())
												...
												<div class="tab-content">
													...
													@include('expedientes.expediente_rigoberto_ver_antecedentes_no_patologicos')
												</div>
											{!! Form::close() !!}
										</div>
										</div>
