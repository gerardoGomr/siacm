	...
	<div class="box-generic">
		<div class="form-group">
			...
			<div class="col-md-4">
				<div class="radio">
					<label>
						{!! Form::radio('viveMadre', 1, $expediente->viveMadre(), ['class' => 'viveMadre']) !!} Viva
					</label>
				</div>

				<div class="radio">
					<label>
						{!! Form::radio('viveMadre', 2, !$expediente->viveMadre() ? true: false, ['class' => 'viveMadre']) !!} Finada
					</label>
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				{!! Form::text('enfermedadesMadre', $expediente->getEnfermedadesMadre(), ['class' => 'form-control']) !!}
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-4">
				<div class="radio">
					<label>
						{!! Form::radio('vivePadre', 1, $expediente->vivePadre(), ['class' => 'vivePadre']) !!} Vivo
					</label>
				</div>

				<div class="radio">
					<label>
						{!! Form::radio('vivePadre', 2, !$expediente->vivePadre() ? true: false, ['class' => 'vivePadre']) !!} Finado
					</label>
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
				{!! Form::text('enfermedadesPadre', $expediente->getEnfermedadesPadre(), ['class' => 'form-control']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('enfermedadesAbuelosPaternos', '*Enfermedades abuelos paternos:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-8">
				{!! Form::textarea('enfermedadesAbuelosPaternos', $expediente->getEnfermedadesAbuelosPaternos(), ['class' => 'form-control', 'rows' => '6']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('enfermedadesAbuelosMaternos', '*Enfermedades abuelos maternos:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-8">
				{!! Form::textarea('enfermedadesAbuelosMaternos', $expediente->getEnfermedadesAbuelosMaternos(), ['class' => 'form-control', 'rows' => '6']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('numHermanos', '*Número de hermanos:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-2">
				{!! Form::text('numHermanos', $expediente->getNumHermanos(), ['class' => 'numerosEnteros form-control']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('numHermanosVivos', '*Vivos:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-2">
				{!! Form::text('numHermanosVivos', $expediente->getNumHermanosVivos(), ['class' => 'numerosEnteros form-control']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('numHermanosFinados', '*Finados:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-2">
				{!! Form::text('numHermanosFinados', $expediente->getNumHermanosFinados(), ['class' => 'numerosEnteros form-control', 'readonly' => 'readonly']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('nombresEdades', '*Nombres y Edades:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-8">
				{!! Form::textarea('nombresEdades', $expediente->getNombresEdadesHermanos(), ['class' => 'form-control', 'rows' => '6']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('enfermedadesHermanos', '*Enfermedades que padecen o padecieron:', ['class' => 'control-label col-md-3']) !!}
			<div class="col-md-8">
				{!! Form::textarea('enfermedadesHermanos', $expediente->getEnfermedadesHermanos(), ['class' => 'form-control', 'rows' => '6']) !!}
			</div>
		</div>
	</div>
</div>
