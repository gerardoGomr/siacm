 ...
 */
class DienteTratamiento extends \Siacme\Dominio\Expedientes\DienteTratamiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DienteTratamiento $proxy) {
