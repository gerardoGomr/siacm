...
class Consulta extends \Siacme\Dominio\Consultas\Consulta implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'id', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'padecimientoActual', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'interrogatorioAparatosSistemas', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'exploracionFisica', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'notaMedica', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'comportamientoFrankl', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'costo', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'pagada', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'comentario', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'costos', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'receta', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'expediente', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'consultaCosto', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'fecha', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'medico', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'cobrosConsulta', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'otrosCostos', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'aRealizarEnProximaCita', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'higieneDentalConsulta', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'indicacionConsulta', '' . "\0" . 'Siacme\\Dominio\\Consultas\\Consulta' . "\0" . 'exploracionOtorrino'];
        }
     ...
     * {@inheritDoc}
     */
    public function addExploracionOtorrino(\Siacme\Dominio\Consultas\ExploracionOtorrino $exploracion)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addExploracionOtorrino', [$exploracion]);

        return parent::addExploracionOtorrino($exploracion);
    }
