 ...
 */
class Interconsulta extends \Siacme\Dominio\Interconsultas\Interconsulta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Interconsulta $proxy) {
    ...
    public function respondida()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'respondida', []);

        return parent::respondida();
    }
