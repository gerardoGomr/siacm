...
namespace DoctrineProxies\__CG__\Siacme\Dominio\Interconsultas;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class MedicoReferencia extends \Siacme\Dominio\Interconsultas\MedicoReferencia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Siacme\\Dominio\\Interconsultas\\MedicoReferencia' . "\0" . 'id', '' . "\0" . 'Siacme\\Dominio\\Interconsultas\\MedicoReferencia' . "\0" . 'direccion', '' . "\0" . 'Siacme\\Dominio\\Interconsultas\\MedicoReferencia' . "\0" . 'especialidad', 'nombre', 'paterno', 'materno', 'sexo', 'telefono', 'celular', 'email'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MedicoReferencia $proxy) {
