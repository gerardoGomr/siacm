 ...
 */
class ExamenExtraoral extends \Siacme\Dominio\Expedientes\ExamenExtraoral implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Siacme\\Dominio\\Expedientes\\ExamenExtraoral' . "\0" . 'morfologiaCraneofacial', '' . "\0" . 'Siacme\\Dominio\\Expedientes\\ExamenExtraoral' . "\0" . 'morfologiaFacial', '' . "\0" . 'Siacme\\Dominio\\Expedientes\\ExamenExtraoral' . "\0" . 'convexividadFacial', '' . "\0" . 'Siacme\\Dominio\\Expedientes\\ExamenExtraoral' . "\0" . 'atm'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExamenExtraoral $proxy) {
