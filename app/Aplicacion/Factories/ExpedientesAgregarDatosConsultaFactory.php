    ...
    public static function agregar(Usuario $medico, Expediente $expediente, Request $request)
    {
        switch ($medico->getId()) {
            case Usuario::JOHANNA:
                ...
                self::addDetallesJohanna($medico, $expediente, $request);
                break;
        }
    }

    /**
     * Agrega los detalles de los expedientes para Johanna
     * 
     * @param Usuario $medico
     * @param Expediente $expediente
     * @param Request $request
     */
    private static function addDetallesJohanna(Usuario $medico, Expediente $expediente, Request $request)
    {
